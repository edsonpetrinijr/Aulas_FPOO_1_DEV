 ...
 * @author Aluno
 */
public class SabadoEDomingo {
    private ModeloEnum modeloDoQuarto;
    
    public SabadoEDomingo(ModeloEnum modeloDoQuarto) {
